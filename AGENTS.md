...
> Последнее обновление: 24.09 — прокрутка и прозрачные категории UI магазина по `godot-ui-control` / `game-ui-ux` / `godot-gdscript`. Требуется ручная визуальная проверка.
